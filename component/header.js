			...
			<div class="container">
				<div class="header">
					...
					<nav class="navigation">
						<ul>
						<div class="search-container" style="margin-top:3%">
	<input type="text" id="searchInput" class="search-bar" placeholder="Search for songs..." onkeyup="filterCards()" />
</div>
							<li>
								<a class="navigation-link" href="./premium.html">Premium</a>
							</li>
							<li>
								<a class="navigation-link" href="./songs/songs.html">Songs</a>
							</li>
							<li>
								<a class="navigation-link" href="./songs/video.html">Videos</a>
							</li>
							<li>
							...
							<li>
								...
								<div id="profileMenu" class="profileMenu">
									<ul class="">
										<li class="">
											<a class="" href="./songs/songs.html">Welcome</a> 
										</li>
